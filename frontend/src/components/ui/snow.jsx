  ...
  return (
    <div className="relative min-h-screen">
      <div
        ...
        style={{
          background: "linear-gradient(to bottom, #e8f0f8 0%, #d4e4f0 40%, #c0d8e8 100%)",
          zIndex: 0,
        }}>
        <canvas ref={canvasRef} className="absolute inset-0 h-full w-full pointer-events-none" style={{ zIndex: 0 }} />
